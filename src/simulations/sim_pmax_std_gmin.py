...
def main(runsim=False, models=['ProfitMax', 'ProfitMax_wGmin', 'Medlyn', 'Medlyn_wGmin']):
    ...
    # path to input files
    ipath = os.path.join(os.path.join(base_dir, 'input'), 'Anne_HW2')
...
if __name__ == "__main__":
    ...
    models = ['ProfitMax', 'ProfitMax_wGmin', 'Medlyn', 'Medlyn_wGmin']
