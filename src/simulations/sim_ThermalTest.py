...
def main(runsim=False, models=['Medlyn', 'ProfitMax', 'ThermalCost']):
    ...
    # path to input files
    ipath = os.path.join(os.path.join(base_dir, 'input'), 'Anne_HW2_constk_nogb')
...
if __name__ == "__main__":
    ...
    models = ['Medlyn', 'ProfitMax', 'ThermalCost']
