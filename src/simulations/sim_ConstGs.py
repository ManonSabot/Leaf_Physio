...
def main(runsim=False, models=['Const0.01', 'Const0.1', 'Const0.2', 'Const0.3', 'Const0.4', 'Const0.5']):
    ...
    # path to input files
    ipath = os.path.join(os.path.join(base_dir, 'input'), 'temp_test_no_gb')
...
if __name__ == "__main__":
    ...
    models = ['Const0.01', 'Const0.1', 'Const0.2', 'Const0.3', 'Const0.4', 'Const0.5']
